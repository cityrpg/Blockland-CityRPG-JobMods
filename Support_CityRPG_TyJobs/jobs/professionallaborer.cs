...
$CityRPG::jobs::name = "Professional Laborer";
...
$CityRPG::jobs::helpline = "\c6Professional Laborer, what do you think it does.";

$CityRPG::jobs::outfit = "none none none none whitet blackShirt skin bluePants brownShoes BrownSmiley Alyx";