...
$CityRPG::jobs::name = "Business Man";
$CityRPG::jobs::initialInvestment = 1000;
$CityRPG::jobs::pay = 110;
$CityRPG::jobs::tools = "";
...
$CityRPG::jobs::helpline = "\c6Business managers are the men who run the business and with medium pay.";

$CityRPG::jobs::outfit = "none none none none whiteShirt blackShirt skin bluePants brownShoes smileyBlonde Mod-Suit";